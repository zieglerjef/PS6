...
#' @param party Party of given candidates, 'Republican' or 'Democratic' (character string).
#'
...
#' \item party Party of candidates, 'Republican' or 'Democratic' (character string).
